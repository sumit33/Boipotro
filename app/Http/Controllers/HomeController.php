...
class HomeController extends Controller
{
    ...
    public function show_product_by_category(Request $request,$category_id)
    {
    ...
    {
        $profile_info=DB::table('tbl_customer')
                    ->where('customer_id',$customer_id)
                    ->get();
        return view('pages.profile_view')->with('profile_info',$profile_info);
    }
