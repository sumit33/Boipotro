			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL :: to('/all-manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Author</span></a></li>
						<li><a href="{{URL :: to('/add-manufacture')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Author</span></a></li>
						<li>
						...
						<li><a href="typography.html"><i class="icon-font"></i><span class="hidden-tablet"> Shopname</span></a></li>
